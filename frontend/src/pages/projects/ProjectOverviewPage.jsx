            ...
            <ul>
              {priorityTasks.map((task, i) => (
                ...
                >
                  ...
                  <p className="flex-1 text-body-md font-geist text-on-surface">
                    {task.title}
                  </p>
                  <Badge
                    variant={
        ...
        <div className="row-span-2 bg-surface-container border border-outline-variant flex flex-col">
          ...
          {addingMember && (
            <form
              ...
              className="px-5 py-3 border-b border-outline-variant flex flex-col gap-2 flex-shrink-0"
            >
              <input
                autoFocus
                type="email"
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    <p className="text-body-md font-geist text-on-surface truncate">
                      ...
                      {isSelf && (
                        <span className="text-on-surface-variant text-mono-label font-mono ml-1">
                          (you)
                        </span>
                      )}
                    </p>
